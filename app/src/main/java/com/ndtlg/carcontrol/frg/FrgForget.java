...
//  FrgForget
//
//  Created by DELL on 2018-09-05 14:10:30
...
import com.ndtlg.carcontrol.bean.BeanforgetPwd;
    ...
    public void loaddata() {
        ...
        mImageView_dl.setOnClickListener(Helper.delayClickLitener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                loadJsonUrl(resetPwd, new BeanforgetPwd(mEditText_phone.getText().toString(), mEditText_pass.getText().toString(), mEditText_code.getText().toString()));
            }
        }));
    }

...
public class PopShowRightCh implements OnClickListener {
    ...
    private Context context;    public int cat;
    public PopShowRightCh(Context context, View view, int cat) {
        super();
        this.view = view;
        this.context = context;    this.cat = cat;
        LayoutInflater flater = LayoutInflater.from(context);
        popview = flater.inflate(R.layout.item_right_pop, null);
    ...
    public void show() {
        ...
        popwindow.showAtLocation(view, Gravity.NO_GRAVITY, (int) (location[0] - view.getWidth()- context.getResources().getDimension(R.dimen.j60dp)), location[1]);
    }
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.mTextView_1:
                Frame.HANDLES.sentAll("FrgMc", 3, cat);
                break;
            case R.id.mTextView_2:
                Frame.HANDLES.sentAll("FrgMc", 4, cat);
                break;
            case R.id.mTextView_3:
                Frame.HANDLES.sentAll("FrgMc", 5, cat);
                break;
        }
    }

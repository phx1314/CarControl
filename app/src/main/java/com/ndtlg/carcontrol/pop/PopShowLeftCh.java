...
public class PopShowLeftCh implements OnClickListener {
    ...
    public PopShowLeftCh(Context context, View view, int cat) {
        super();
        this.view = view;
        this.cat = cat;
        LayoutInflater flater = LayoutInflater.from(context);
        popview = flater.inflate(R.layout.item_left_pop, null);
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.mTextView_1:
                Frame.HANDLES.sentAll("FrgMc", 0, cat);
                break;
            case R.id.mTextView_2:
                Frame.HANDLES.sentAll("FrgMc", 1, cat);
                break;
            case R.id.mTextView_3:
                Frame.HANDLES.sentAll("FrgMc", 2, cat);
                break;
        }
    }

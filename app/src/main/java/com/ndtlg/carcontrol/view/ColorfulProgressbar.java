...
public class ColorfulProgressbar extends ViewGroup {
    ...
    private int backgroundColor = Color.parseColor("#00000000");    //背景颜色
    private int secondProgressColor = Color.parseColor("#00000000");  //第二进度条颜色
    private int progressColor = Color.parseColor("#930000");    //进度条颜色一
    private int progressColor2 = getResources().getColor(R.color.A);  //进度条颜色二
    private int percentColor = Color.TRANSPARENT;          //进度文字的颜色，默认黄色
    private int percentShaderColor = Color.TRANSPARENT;   //进度文字的阴影颜色，默认暗灰色
